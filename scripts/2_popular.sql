...
INSERT INTO `Treinador` (`id_treinador`, `nome`, `cidade`, `data_inscricao`, `pontos_ranking`) VALUES
  (1, 'Davi Lucas Silveira', 'Pallet Town', '2024-06-14', 0),
  (2, 'Mirella Silveira', 'Cerulean City', '2024-07-21', 0),
  (3, 'Otávio da Mata', 'Six Island', '2024-02-07', 0),
  (4, 'Enrico da Luz', 'Outcast Island', '2024-02-18', 0),
  (5, 'Sophia Fonseca', 'Cerulean City', '2024-10-25', 0),
  (6, 'Oliver da Conceição', 'Three Island', '2025-04-10', 0),
  (7, 'Davi Luiz da Cunha', 'Cerulean City', '2024-04-19', 0),
  (8, 'Davi Lucca das Neves', 'Four Island', '2024-02-14', 0),
  (9, 'Sr. José Cassiano', 'Cinnabar Island', '2024-08-02', 0),
  (10, 'Yago Alves', 'Cinnabar Island', '2024-05-03', 0),
  (11, 'Rafaela Santos', 'Four Island', '2024-10-09', 0),
  (12, 'Theodoro Guerra', 'Seven Island', '2024-01-31', 0),
  (13, 'Arthur Miguel Gonçalves', 'Pewter City', '2024-03-04', 0),
  (14, 'Antonella Jesus', 'Seven Island', '2024-11-18', 0),
  (15, 'Dra. Alexia Sampaio', 'Cerulean City', '2025-04-30', 0),
  (16, 'Amanda Câmara', 'Seven Island', '2024-10-22', 0),
  (17, 'Joaquim Albuquerque', 'Cerulean City', '2024-07-22', 0),
  (18, 'Dr. Bruno Leão', 'Pewter City', '2025-05-14', 0),
  (19, 'Sra. Aurora Montenegro', 'Six Island', '2024-01-24', 0),
  (20, 'Sarah Souza', 'Pallet Town', '2025-03-15', 0),
  (21, 'Evelyn Vieira', 'Four Island', '2024-05-28', 0),
  (22, 'João Guilherme Costa', 'Six Island', '2024-03-14', 0),
  (23, 'Heloísa Camargo', 'Seven Island', '2024-03-01', 0),
  (24, 'Thales Peixoto', 'Six Island', '2024-06-06', 0),
  (25, 'Isis Sousa', 'Vermilion City', '2025-02-21', 0),
  (26, 'Juan Cunha', 'Seven Island', '2024-02-22', 0),
  (27, 'Davi Lucas Marques', 'Viridian City', '2024-10-19', 0),
  (28, 'Dr. Benício Mendes', 'Fuchsia City', '2024-07-09', 0),
  (29, 'Felipe Mendonça', 'Cinnabar Island', '2024-10-07', 0),
  (30, 'Luiz Gustavo Caldeira', 'Cerulean City', '2024-10-15', 0),
  (31, 'Lívia Lopes', 'Viridian City', '2024-11-12', 0),
  (32, 'Ana Sophia Lima', 'Six Island', '2024-09-11', 0),
  (33, 'José Pedro da Conceição', 'Saffron City', '2024-08-06', 0),
  (34, 'Bianca Aparecida', 'Seven Island', '2024-08-26', 0),
  (35, 'Sra. Mariana Gomes', 'Five Island', '2025-04-17', 0),
  (36, 'Lucas Gabriel Farias', 'Indigo Plateau', '2024-07-04', 0),
  (37, 'Rhavi da Cruz', 'Vermilion City', '2024-05-07', 0),
  (38, 'Henry Gabriel Monteiro', 'Pewter City', '2024-12-23', 0),
  (39, 'Gabrielly Moraes', 'Seven Island', '2024-02-11', 0),
  (40, 'Dr. Vicente Moraes', 'Three Island', '2024-06-02', 0),
  (41, 'Dra. Clara Andrade', 'Saffron City', '2024-09-10', 0),
  (42, 'Gustavo Santos', 'Five Island', '2025-01-08', 0),
  (43, 'Pedro Henrique Barbosa', 'Birth Island', '2024-05-27', 0),
  (44, 'Elisa Nascimento', 'Fuchsia City', '2024-02-07', 0),
  (45, 'Anthony Gabriel Cavalcante', 'Four Island', '2024-09-19', 0),
  (46, 'Sr. Josué da Costa', 'Saffron City', '2024-03-25', 0),
  (47, 'Manuella Vargas', 'Two Island', '2024-03-18', 0),
  (48, 'Dr. Thiago Vieira', 'Cerulean City', '2024-08-03', 0),
  (49, 'Amanda Lopes', 'Cinnabar Island', '2025-05-07', 0),
  (50, 'Anthony Gabriel Ribeiro', 'Six Island', '2025-01-26', 0),
  (51, 'Gabriel Aparecida', 'Saffron City', '2024-10-20', 0),
  (52, 'Lorenzo Fonseca', 'Outcast Island', '2024-06-23', 0),
  (53, 'Ana Vitória Sampaio', 'Two Island', '2024-10-31', 0),
  (54, 'Maria Clara Rezende', 'Five Island', '2024-10-23', 0),
  (55, 'Dr. Enzo Gabriel Cavalcanti', 'Cinnabar Island', '2024-02-05', 0),
  (56, 'Hellena Siqueira', 'Lavender Town', '2025-04-28', 0),
  (57, 'Gabriela Cassiano', 'Cinnabar Island', '2024-08-30', 0),
  (58, 'Cecilia Machado', 'Indigo Plateau', '2024-02-01', 0),
  (59, 'João Guilherme Montenegro', 'Seven Island', '2024-11-27', 0),
  (60, 'Srta. Lunna Silva', 'Five Island', '2024-12-14', 0),
  (61, 'Letícia Costela', 'One Island', '2024-05-25', 0),
  (62, 'Ana Laura Duarte', 'Outcast Island', '2025-03-30', 0),
  (63, 'Rafaela da Rosa', 'Five Island', '2024-01-12', 0),
  (64, 'Lívia Fogaça', 'Vermilion City', '2024-06-30', 0),
  (65, 'Ana Beatriz da Paz', 'Fuchsia City', '2024-11-08', 0),
  (66, 'Jade Barbosa', 'Cerulean City', '2024-09-09', 0),
  (67, 'Enzo Siqueira', 'Indigo Plateau', '2024-04-21', 0),
  (68, 'Catarina Araújo', 'Pewter City', '2024-03-07', 0),
  (69, 'Juliana Ferreira', 'One Island', '2024-07-22', 0),
  (70, 'Sr. Francisco da Mata', 'Two Island', '2025-04-14', 0),
  (71, 'Sra. Lorena Lopes', 'Vermilion City', '2024-02-11', 0),
  (72, 'Isabella Teixeira', 'One Island', '2024-08-17', 0),
  (73, 'Léo Vieira', 'Lavender Town', '2024-10-08', 0),
  (74, 'Sr. Enzo Gabriel Nogueira', 'Pallet Town', '2025-03-28', 0),
  (75, 'Dra. Ana Clara Moura', 'Four Island', '2025-02-23', 0),
  (76, 'Beatriz Martins', 'Six Island', '2025-03-18', 0),
  (77, 'Melissa Araújo', 'Four Island', '2024-05-22', 0),
  (78, 'Anna Liz Araújo', 'One Island', '2024-07-02', 0),
  (79, 'Henry Alves', 'Pewter City', '2025-05-05', 0),
  (80, 'Anthony Gabriel da Mota', 'Cinnabar Island', '2024-03-18', 0),
  (81, 'Natália Jesus', 'Pallet Town', '2024-03-31', 0),
  (82, 'Srta. Olívia Rocha', 'Pewter City', '2024-04-28', 0),
  (83, 'Fernanda Andrade', 'Two Island', '2024-01-07', 0),
  (84, 'Ravy Mendonça', 'Seven Island', '2025-03-01', 0),
  (85, 'Vitor Gabriel Barbosa', 'Lavender Town', '2024-04-03', 0),
  (86, 'Luiz Henrique Vieira', 'Celadon City', '2024-05-24', 0),
  (87, 'Davi Lucca Ferreira', 'Four Island', '2024-03-15', 0),
  (88, 'Sr. Anthony Gabriel Lima', 'Outcast Island', '2024-09-30', 0),
  (89, 'Alice Rezende', 'Seven Island', '2024-11-08', 0),
  (90, 'José Pedro Casa Grande', 'Pallet Town', '2024-06-12', 0),
  (91, 'Isabela Pinto', 'Three Island', '2024-12-19', 0),
  (92, 'Cecília da Costa', 'Birth Island', '2025-05-01', 0),
  (93, 'Davi Nogueira', 'Cerulean City', '2024-12-01', 0),
  (94, 'Sr. Théo Rezende', 'Six Island', '2024-08-21', 0),
  (95, 'Luigi Nunes', 'One Island', '2024-07-19', 0),
  (96, 'Clara Moura', 'One Island', '2024-07-23', 0),
  (97, 'Bernardo Gonçalves', 'Two Island', '2024-02-23', 0),
  (98, 'Sabrina Duarte', 'One Island', '2024-11-20', 0),
  (99, 'Melina Aparecida', 'Viridian City', '2024-02-01', 0),
  (100, 'Fernanda Fernandes', 'Viridian City', '2024-02-04', 0),
  (101, 'Asafe Barros', 'Vermilion City', '2024-08-13', 0),
  (102, 'Pedro Miguel Correia', 'Saffron City', '2024-02-26', 0),
  (103, 'Maria Sophia Fonseca', 'Cerulean City', '2024-11-03', 0),
  (104, 'Maria Laura Cassiano', 'Celadon City', '2024-02-22', 0),
  (105, 'Ísis Pimenta', 'Pallet Town', '2024-10-17', 0),
  (106, 'José da Rosa', 'Fuchsia City', '2024-10-01', 0),
  (107, 'Francisco Vieira', 'Outcast Island', '2025-04-30', 0),
  (108, 'Diego Monteiro', 'Celadon City', '2024-11-10', 0),
  (109, 'Alexandre Mendonça', 'Viridian City', '2024-02-06', 0),
  (110, 'Maria Luiza da Conceição', 'One Island', '2024-11-10', 0),
  (111, 'Isabelly Rezende', 'Lavender Town', '2024-03-17', 0),
  (112, 'Pedro Miguel Rocha', 'Outcast Island', '2025-05-04', 0),
  (113, 'Josué Vargas', 'Outcast Island', '2024-11-04', 0),
  (114, 'Elisa Cirino', 'Fuchsia City', '2024-08-30', 0),
  (115, 'Srta. Olivia Pacheco', 'Two Island', '2024-02-29', 0),
  (116, 'Dr. Felipe Machado', 'Five Island', '2025-05-15', 0),
  (117, 'Alexia Rocha', 'Two Island', '2024-09-02', 0),
  (118, 'Ana Luiza Caldeira', 'Cinnabar Island', '2024-06-08', 0),
  (119, 'Kaique Cunha', 'Fuchsia City', '2024-03-14', 0),
  (120, 'Léo da Rocha', 'Saffron City', '2025-01-18', 0);
