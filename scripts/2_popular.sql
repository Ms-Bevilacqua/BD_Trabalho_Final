...
INSERT INTO `Treinador` (`id_treinador`, `nome`, `cidade`, `data_inscricao`, `pontos_ranking`) VALUES
  (1, 'Kevin Barbosa', 'Pallet Town', '2024-06-14', 0),
  (2, 'Pietro Lopes', 'Cerulean City', '2024-07-21', 0),
  (3, 'Maria Luiza Nunes', 'Six Island', '2024-02-07', 0),
  (4, 'Diego Barros', 'Outcast Island', '2024-02-18', 0),
  (5, 'Bárbara Porto', 'Cerulean City', '2024-10-25', 0),
  (6, 'Sr. Bernardo Albuquerque', 'Three Island', '2025-04-10', 0),
  (7, 'Theodoro Cunha', 'Cerulean City', '2024-04-19', 0),
  (8, 'Josué Martins', 'Four Island', '2024-02-14', 0),
  (9, 'Eduarda Oliveira', 'Cinnabar Island', '2024-08-02', 0),
  (10, 'Emanuella Guerra', 'Cinnabar Island', '2024-05-03', 0),
  (11, 'Dra. Hellena Novais', 'Four Island', '2024-10-09', 0),
  (12, 'Matheus da Costa', 'Seven Island', '2024-01-31', 0),
  (13, 'Renan da Paz', 'Pewter City', '2024-03-04', 0),
  (14, 'Milena Farias', 'Seven Island', '2024-11-18', 0),
  (15, 'Cecilia Porto', 'Cerulean City', '2025-04-30', 0),
  (16, 'Hadassa Lopes', 'Seven Island', '2024-10-22', 0),
  (17, 'Sra. Maya Castro', 'Cerulean City', '2024-07-22', 0),
  (18, 'Maria Isis Cavalcanti', 'Pewter City', '2025-05-14', 0),
  (19, 'João Pedro Alves', 'Six Island', '2024-01-24', 0),
  (20, 'Sabrina Sá', 'Pallet Town', '2025-03-15', 0),
  (21, 'Clarice Machado', 'Four Island', '2024-05-28', 0),
  (22, 'Gabrielly da Costa', 'Six Island', '2024-03-14', 0),
  (23, 'Sr. Ryan Novais', 'Seven Island', '2024-03-01', 0),
  (24, 'Valentina Sampaio', 'Six Island', '2024-06-06', 0),
  (25, 'Maya Peixoto', 'Vermilion City', '2025-02-21', 0),
  (26, 'Marcos Vinicius Cunha', 'Seven Island', '2024-02-22', 0),
  (27, 'Fernanda Pires', 'Viridian City', '2024-10-19', 0),
  (28, 'Agatha Souza', 'Fuchsia City', '2024-07-09', 0),
  (29, 'Heitor Andrade', 'Cinnabar Island', '2024-10-07', 0),
  (30, 'Igor Cavalcante', 'Cerulean City', '2024-10-15', 0),
  (31, 'Dra. Isabel Costa', 'Viridian City', '2024-11-12', 0),
  (32, 'Maria Júlia Monteiro', 'Six Island', '2024-09-11', 0),
  (33, 'Amanda Moreira', 'Saffron City', '2024-08-06', 0),
  (34, 'Srta. Mariana Lima', 'Seven Island', '2024-08-26', 0),
  (35, 'Francisco Caldeira', 'Five Island', '2025-04-17', 0),
  (36, 'Melissa Vasconcelos', 'Indigo Plateau', '2024-07-04', 0),
  (37, 'Vinicius Rezende', 'Vermilion City', '2024-05-07', 0),
  (38, 'Marcos Vinicius Novais', 'Pewter City', '2024-12-23', 0),
  (39, 'Carolina Araújo', 'Seven Island', '2024-02-11', 0),
  (40, 'Sr. João Vitor Rocha', 'Three Island', '2024-06-02', 0),
  (41, 'Camila Ramos', 'Saffron City', '2024-09-10', 0),
  (42, 'Gabriela Porto', 'Five Island', '2025-01-08', 0),
  (43, 'Théo Fonseca', 'Birth Island', '2024-05-27', 0),
  (44, 'Maria Liz Casa Grande', 'Fuchsia City', '2024-02-07', 0),
  (45, 'Calebe Cavalcanti', 'Four Island', '2024-09-19', 0),
  (46, 'Sr. Bernardo da Cruz', 'Saffron City', '2024-03-25', 0),
  (47, 'Liam Pacheco', 'Two Island', '2024-03-18', 0),
  (48, 'Benicio Sampaio', 'Cerulean City', '2024-08-03', 0),
  (49, 'Caroline Casa Grande', 'Cinnabar Island', '2025-05-07', 0),
  (50, 'Breno Azevedo', 'Six Island', '2025-01-26', 0),
  (51, 'Yan Monteiro', 'Saffron City', '2024-10-20', 0),
  (52, 'Natália Borges', 'Outcast Island', '2024-06-23', 0),
  (53, 'Ana Luiza Mendes', 'Two Island', '2024-10-31', 0),
  (54, 'João Guilherme Cassiano', 'Five Island', '2024-10-23', 0),
  (55, 'Dra. Clarice Brito', 'Cinnabar Island', '2024-02-05', 0),
  (56, 'Daniela Gonçalves', 'Lavender Town', '2025-04-28', 0),
  (57, 'Theo Oliveira', 'Cinnabar Island', '2024-08-30', 0),
  (58, 'Gabrielly Teixeira', 'Indigo Plateau', '2024-02-01', 0),
  (59, 'Dr. Luan Pereira', 'Seven Island', '2024-11-27', 0),
  (60, 'Danilo Brito', 'Five Island', '2024-12-14', 0),
  (61, 'Amanda Sá', 'One Island', '2024-05-25', 0),
  (62, 'Dra. Esther Nascimento', 'Outcast Island', '2025-03-30', 0),
  (63, 'Ana Pacheco', 'Five Island', '2024-01-12', 0),
  (64, 'Josué Castro', 'Vermilion City', '2024-06-30', 0),
  (65, 'Maria Sophia Cavalcanti', 'Fuchsia City', '2024-11-08', 0),
  (66, 'Emanuella Sales', 'Cerulean City', '2024-09-09', 0),
  (67, 'Leandro Carvalho', 'Indigo Plateau', '2024-04-21', 0),
  (68, 'Luan Sampaio', 'Pewter City', '2024-03-07', 0),
  (69, 'Nina Moura', 'One Island', '2024-07-22', 0),
  (70, 'Sr. Heitor Silva', 'Two Island', '2025-04-14', 0),
  (71, 'Srta. Lunna Costa', 'Vermilion City', '2024-02-11', 0),
  (72, 'Vitor Gabriel Marques', 'One Island', '2024-08-17', 0),
  (73, 'Lívia Castro', 'Lavender Town', '2024-10-08', 0),
  (74, 'Kaique Marques', 'Pallet Town', '2025-03-28', 0),
  (75, 'Cecilia Pires', 'Four Island', '2025-02-23', 0),
  (76, 'Ágatha Freitas', 'Six Island', '2025-03-18', 0),
  (77, 'Matteo da Mata', 'Four Island', '2024-05-22', 0),
  (78, 'Sr. Liam Farias', 'One Island', '2024-07-02', 0),
  (79, 'Felipe Moura', 'Pewter City', '2025-05-05', 0),
  (80, 'Melissa Ramos', 'Cinnabar Island', '2024-03-18', 0),
  (81, 'Carolina Fogaça', 'Pallet Town', '2024-03-31', 0),
  (82, 'Benicio Macedo', 'Pewter City', '2024-04-28', 0),
  (83, 'Olívia Cirino', 'Two Island', '2024-01-07', 0),
  (84, 'Bárbara Araújo', 'Seven Island', '2025-03-01', 0),
  (85, 'Theo Carvalho', 'Lavender Town', '2024-04-03', 0),
  (86, 'Sophie Mendes', 'Celadon City', '2024-05-24', 0),
  (87, 'Dr. Luigi Pacheco', 'Four Island', '2024-03-15', 0),
  (88, 'Dr. Cauã Costa', 'Outcast Island', '2024-09-30', 0),
  (89, 'João Gabriel Borges', 'Seven Island', '2024-11-08', 0),
  (90, 'Liz Porto', 'Pallet Town', '2024-06-12', 0),
  (91, 'Sr. Henry Azevedo', 'Three Island', '2024-12-19', 0),
  (92, 'Esther Vieira', 'Birth Island', '2025-05-01', 0),
  (93, 'Sr. Rafael Mendes', 'Cerulean City', '2024-12-01', 0),
  (94, 'Antony Peixoto', 'Six Island', '2024-08-21', 0),
  (95, 'Dra. Yasmin Araújo', 'One Island', '2024-07-19', 0),
  (96, 'Juan Ferreira', 'One Island', '2024-07-23', 0),
  (97, 'Arthur Miguel Gomes', 'Two Island', '2024-02-23', 0),
  (98, 'Isabella Vasconcelos', 'One Island', '2024-11-20', 0),
  (99, 'Maria Cecília Fernandes', 'Viridian City', '2024-02-01', 0),
  (100, 'Dra. Maria Laura Sá', 'Viridian City', '2024-02-04', 0),
  (101, 'Dra. Giovanna Almeida', 'Vermilion City', '2024-08-13', 0),
  (102, 'Isabel Pinto', 'Saffron City', '2024-02-26', 0),
  (103, 'Levi Montenegro', 'Cerulean City', '2024-11-03', 0),
  (104, 'Luigi Pastor', 'Celadon City', '2024-02-22', 0),
  (105, 'Caleb Aragão', 'Pallet Town', '2024-10-17', 0),
  (106, 'Ísis Carvalho', 'Fuchsia City', '2024-10-01', 0),
  (107, 'Lorenzo Aparecida', 'Outcast Island', '2025-04-30', 0),
  (108, 'Sra. Giovanna Almeida', 'Celadon City', '2024-11-10', 0),
  (109, 'Sr. Leonardo Siqueira', 'Viridian City', '2024-02-06', 0),
  (110, 'Sr. Liam Brito', 'One Island', '2024-11-10', 0),
  (111, 'Dr. Carlos Eduardo Albuquerque', 'Lavender Town', '2024-03-17', 0),
  (112, 'Kevin Araújo', 'Outcast Island', '2025-05-04', 0),
  (113, 'Dr. Asafe da Conceição', 'Outcast Island', '2024-11-04', 0),
  (114, 'Luana Novaes', 'Fuchsia City', '2024-08-30', 0),
  (115, 'Sra. Milena Pimenta', 'Two Island', '2024-02-29', 0),
  (116, 'Melina Dias', 'Five Island', '2025-05-15', 0),
  (117, 'Ravi Andrade', 'Two Island', '2024-09-02', 0),
  (118, 'Thomas Teixeira', 'Cinnabar Island', '2024-06-08', 0),
  (119, 'Davi Lucas Nunes', 'Fuchsia City', '2024-03-14', 0),
  (120, 'Luiz Miguel da Cunha', 'Saffron City', '2025-01-18', 0);
